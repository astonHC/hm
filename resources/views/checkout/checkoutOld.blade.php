...
<html lang="en">
    ...
    <script>
        function checkForm() {
            ...
            formInputs = document.querySelector(
    ...
    <body>
        ...
        >
            <div>
                <ol
                    class="flex items-center w-full text-sm text-center dark:text-yellow-800 sm:text-xl"
                >
                    <li
                    ...
                    >
                        ...
                        >
                            ...
                            Billing<span class="hidden sm:inline-flex sm:ms-2"
                                >Information</span
                            >
                        </span>
                    </li>
                ...
                <form
                    ...
                    class="w-full max-w-lg center mt-5 ml-auto mr-auto"
                >
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                            ...
                            <input
                                ...
                                placeholder="Jane"
                            />
                            <p hidden class="text-red-500 text-xs italic">
                    ...
                    <div class="flex flex-wrap">
                        <button
                            class="bg-amber rounded-lg p-3 mt-3 ml-auto pl-5 pr-5"
                            onclick="checkForm()"
                        >
                            Proceed
                        </button>
