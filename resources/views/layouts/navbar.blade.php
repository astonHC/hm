        ...
        <nav class="navbar flex justify-between items-center bg-amber text-white px-6 py-4">
            ...
            <div class="flex space-x-4 items-center">
                ...
                <div class="flex items-center space-x-4">
                    <!-- search bar -->
                    <input id="searchBar" type="text" placeholder="Search" class="hidden md:block w-48 bg-white text-black placeholder-gray-500 rounded-full px-4 py-2 shadow-lg focus:outline-none focus:ring-2 focus:ring-amber-500 transition"/>

                    <!-- search icon -->
                    <button id="searchIcon" class="text-white hover:text-gray-200 focus:outline-none" onclick="toggleSearchBar()">
