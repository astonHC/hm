<footer>
    <div class="container mx-auto flex flex-wrap justify-evenly items-center">
        ...
        <a href="https://www.paypal.com/donate/?hosted_button_id=VZZ8YQ994DXUE" class="bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-2 px-4 rounded mt-4 inline-block">Donate</a>
    </div>
    <div class="w-full md:w-1/3 mt-4 md:mt-0">
