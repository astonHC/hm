<footer
    ...
    class="absolute bottom-0 w-screen h-fit-content border border-black"
>
    <div class="container mx-auto flex justify-between h-fit">
        ...
        <div class="w-full md:w-1/3 mt-4 md:mt-0 flex flex-col items-start">
            ...
            <a
                ...
                class="bg-white text-black hover:bg-white hover:text-amber font-bold py-2 px-4 rounded mt-4 inline-block"
                >Donate</a
            >
        </div>
