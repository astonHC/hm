...
<html lang="en">
    ...
    <body>
        ...
        <main>
            <!-- added a backdrop -->
            <section class="bg-white py-40 bg-cover bg-center" style="background-image: url('{{ asset('../Images/hd bee backdrop lols.jpeg') }}');">
            ...
            <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                <h2 class="text-3xl font-bold text-orange-900 mb-5">Help our mission to save the bees</h2>
                <p class="text-orange-800 text-lg mb-3">100% natural ingredients, cruelty-free and sweet like honey.</p>
                <p class="text-orange-800 text-lg mb-3">With your contribution, our bees can continue to keep the world spinning.</p>
                <p class="text-orange-800 text-lg mb-6">Browse our wide range of products below and be(e) a star.</p>
            </div>
            </section>
            ...
            <section class="py-12">
            <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                <h2 class="text-2xl font-bold text-orange-900 mb-6">Shop our products by category</h2>
